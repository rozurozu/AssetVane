...
| `get_valuation(code)` | バリュエーション/ファンダ事実（PER/PBR/ROE/利益率/配当利回り/YoY 成長率＋業種内ランク＋`last_restatement_at`〔最新の訂正有報・提出日／無ければ null・[ADR-063](decisions.md)〕・market:JP 明示・verdict なし＝[ADR-048](decisions.md)）| 2〜 |
