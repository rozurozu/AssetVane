...
| `docs/decisions.md` | **ADR-001〜054。なぜそうしたかの全記録。最重要** |
...
| `docs/roadmap.md` | Phase 0〜7。**Phase 1〜4 ＋ Phase 6 ＋ Phase 7(A) 実装済み・Phase 5 は推論経路まで実装済み（backend＋frontend 通し検証済み・実ニュース取得＋Discord 通知＋日米業種リードラグまで完了。Phase 2 backtest 画面接続は 2026-06-08 に完了）。Phase 5 の学習実測・Phase 7(B) 米株拡張・ニュース意味検索系（ADR-045/050/051/052）が残** |
